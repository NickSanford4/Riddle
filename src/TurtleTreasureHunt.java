...
Tortoise.move(tortoiseSpeed);
 ...
 if (tortoiseLocationX == 503 && tortoiseLocationY == 297){
	JOptionPane.showMessageDialog(null, "The key is wet and slimey");
 }
	if (tortoiseLocationX == 326 && tortoiseLocationY == 405){
